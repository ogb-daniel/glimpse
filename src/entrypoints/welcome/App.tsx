...
function App() {
  ...
  useEffect(() => {
    const handleMouseDown = (e: MouseEvent) => {
      ...
      // Start the hold timer — selection is checked when it fires,
      ...
      >
        ...
        <div style={{ fontSize: "14px" }}>
          {identityReady ? (
            ...
            <p style={{ color: "var(--ink-secondary)", margin: "4px 0" }}>
          ...
          {aiStatus === "downloadable" && (
            <p style={{ color: "var(--accent-gold-hc)", margin: "4px 0" }}>
              ...
              >
                ...
                <li>
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      browser.tabs.create({ url: "chrome://components" });
                    }}
                  >
                    chrome://components
                  </a>{" "}
